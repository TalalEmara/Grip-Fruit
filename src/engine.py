...
from levelManager import make_warmup_level
...
def initialize(width, height):
    ...
    level.start()
    currentItem = None
    return renderer, clock, score_manager, level, currentItem
...
if __name__ == "__main__":
    settings = config()
    renderer, clock, score_manager, level, currentItem  = initialize(settings["width"],settings["height"])
